...
//Esta función calcula el máximo com;un divisor de los números N1 y N2.
{
    int I;
    if (N1 < N2)
        I = N1 / 2;
    ...
    while ((N1 % I) || (N2 % I))
        ...
        sean distintos de cero. Cuando el resultado de la evaluación
        sea 0, el ciclo se detiene ya que se habrá encontrado el máximo
        común divisor. */
    I--;
    return I;
}
