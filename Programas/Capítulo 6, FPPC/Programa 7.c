...
/* Fábrica de Lácteos.
El programa, al recibir como dato las ventas mensuales
de diferentes productos, obtiene información estadística
...
void Lectura1 (int A[][12])
{
    ...
    {
        A[MES-1][PRO-1] += CAN;
        printf ("Ingres Mes Tipo de Producto y Cantidad Vendida: ");
        scanf ("%d %d %d", &MES, &PRO, &CAN);
    }
}
