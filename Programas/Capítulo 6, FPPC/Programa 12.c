...
tridimensional que contiene información sobre
lluvias, genera información estadística. */
...
void Funcion2 (float A[][MES][ANO], int F, int C, int P)
{
    ...
    printf ("\n\nProviencia con Menor Registro Anual de Lluvias en el Último Año: %d", EMEN+1);
