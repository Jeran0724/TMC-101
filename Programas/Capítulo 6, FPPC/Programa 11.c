...
/* Casa de Bolsa.
El programa, al recibir como datos los precios mensuales
de las acciones de sus cinco fondos de inversión, además
del precio de las acciones al 31 de diciembre del 2003,
genera información estadística importante para la empresa. */
...
{
    int I;
    printf ("\nRendimientos Anuelaes de los Fondos");
    for (I=0; I<F; I++)
    {
