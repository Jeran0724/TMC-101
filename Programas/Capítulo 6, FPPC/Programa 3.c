...
/* Universidad.
El programa, al recibir información sobre el número
de alumnos que han ingresado a sus ocho diferentes
carreras en los dos semestres lectivos de los
úlitmos cinco años, obtiene información útil para el
...
void Funcion2 (int A[][C][P], int FI, int CO, int PR)
{
    ...
    printf ("\n\nCarrera con Mayor Número de Estudiantes: %d\t Alumnos: %d", CAR+1, MAY);
}
